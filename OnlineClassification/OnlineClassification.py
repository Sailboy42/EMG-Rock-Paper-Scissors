...
import OnlineClassification.ChosenFeatures as ChosenFeatures # I created this list of 6 chosen featur es 
import OnlineClassification.Functions as Functions # holds various functions I mde to be used here
from sklearn.metrics import accuracy_score # using to get accuracy of data
from sklearn.ensemble import BaggingClassifier
from sklearn.tree import DecisionTreeClassifier
from OnlineClassification.ChosenFeatures import extract_features
from sklearn.metrics import confusion_matrix
import seaborn as sns
import pandas as pd
from OnlineClassification.PreProcess import preprocess_data #import function I made to preprocess data
...
class RunPythonModel:
    ...
    def get_rps(self,data):
        ...
        np_data = data[:, 1:-1]
        #pre process
        FilteredData = preprocess_data(np_data) #this returns filtered data
        ...
        ExtractedFeatures = ChosenFeatures.extract_features(FilteredData) 

        #reshape by 1,-1 to let sy py do classification 
        ReshapedFeatures = ExtractedFeatures.reshape([1, -1])
        print(ReshapedFeatures)
        #call self.model.predict with x test and add 1

        return self.model.predict(ReshapedFeatures)[0]+1 # retunrs an array with a 0,1, or 2
